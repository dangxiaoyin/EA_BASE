...
- (void)initial
{
    ...
    // 4.箭头图片
    UIImageView *arrowImage = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"ic_pulltorefresh_arrow"]];
...
//            }
            ...
            if ([_delegate respondsToSelector:@selector(startRequestData:)]) {
                [_delegate startRequestData:self];
            }
//            // 回调
